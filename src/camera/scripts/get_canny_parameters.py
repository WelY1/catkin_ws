...
# mask=cv2.fillPoly(mask,np.array([[[1000,813],[1425,813],[1452,847],[1004,853]]]),color=255)   #对感兴趣区域制作掩膜    yutong_find_scale_x
mask=cv2.fillPoly(mask,np.array([[[875,534],[919,534],[905,606],[855,606]]]),color=255)   #对感兴趣区域制作掩膜    yutong_find_scale_x
