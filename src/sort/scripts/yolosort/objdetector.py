...
so_path = RosPack().get_path('sort') + '/scripts/yolosort/yolov4/libyolo_layer.so'
try:
...
class TrtYOLO(object):
    ...
    def __init__(self):
        ...
        self.model = RosPack().get_path('sort') + '/scripts/yolosort/yolov4/yolov4-tiny.trt'
    ...
    def detect(self, img, letter_box=None):
        ...
        boxes_pred[:, [0, 2]] = np.clip(boxes_pred[:, [0, 2]], 0, img.shape[1]-1)
        boxes_pred[:, [1, 3]] = np.clip(boxes_pred[:, [1, 3]], 0, img.shape[0]-1)
